...
The pricing policy's USD6 targets are market-specific. Standard uses $25 entry, $8 live reserve, $5 access, and $2.50 + $2.50 exit shares. Micro uses $3 / $1 / $0.50 / $0.25 + $0.25. Exact AZL values vary with the oracle and are rounded up. Read `quoteTask()`; never hardcode token quantities. See [`MARKETS.md`](MARKETS.md).
